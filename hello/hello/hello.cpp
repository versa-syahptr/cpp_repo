...
void greetings_1301213373(string x, string y)
{
    if (y.length() != 10)
    {
...
void swap_1_1301213373(int a, int b, int c){
    c=b;
    b=a;
    a=c*b++;
}

void swap_2_1301213373(int a, int &b, int &c){
    c = b;
    b = a;
    a = c*b++;
}

void confused_1301213373(){
    int x1 = 5;
    int x2 = 5;
    int x3 = 5;
...
void remove_inside_1301213373(int x){
...
string indexing_1301213373(double x, double y, double z){
